...
<html>
<head>
    <title>ΕΠΕΞΕΡΓΑΣΙΑ ΑΡΘΡΟΥ</title>
...
<div style="margin-left: 250px; padding: 20px;">
    <h1>ΕΠΕΞΕΡΓΑΣΙΑ ΑΡΘΡΟΥ</h1>

    <?php
// Assuming the database connection is established and $conn is your mysqli connection object
...
<form action='update_article.php' method='post'>
    ...
    <textarea name="content" id="content" rows="10" cols="80"><?= $row['content'] ?></textarea><br>
...
<?php
 ...
 $conn->close(); // It's better to close the connection after all your database operations are done
?>
 <script>
        // Make sure to replace 'content' with the correct ID of the textarea
