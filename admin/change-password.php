...
<html>
<head>
<title>THALATTA ΑΛΛΑΓΗ ΚΩΔΙΚΟΥ</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Profile <i class="fa fa-angle-right"></i> ΑΛΛΑΓΗ ΚΩΔΙΚΟΥ</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
					<form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label">ΚΩΔΙΚΟΣ</label>
							<div class="col-md-8">
	...
	<div class="form-group">
							<label class="col-md-2 control-label">ΝΕΩΣ ΚΩΔΙΚΟΣ</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
	...
	<div class="form-group">
							<label class="col-md-2 control-label">ΕΠΙΒΕΒΑΙΩΣΗ ΚΩΔΙΚΟΥ</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
				...
				<button type="submit" name="submit" class="btn-primary btn">ΥΠΟΒΟΛΗ</button>
